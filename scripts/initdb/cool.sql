...
) ENGINE=InnoDB AUTO_INCREMENT=15260 DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `base_sys_menu` VALUES (150, '2021-12-17 09:39:50.502573', '2021-12-17 01:40:01.327000', NULL, '境外', NULL, NULL, 0, 'icon-menu', 0, NULL, 1, 1);
...
CREATE TABLE `base_sys_user` (
  ...
  `typeStatus` tinyint(4) NOT NULL DEFAULT '0' COMMENT '前台 0:前台 1：后台',
  PRIMARY KEY (`id`),
...
CREATE TABLE `demo_user` (
  ...
  `type` tinyint(4) NOT NULL DEFAULT '0' COMMENT '性别 0-未知 1-男 2-女',
...
CREATE TABLE `news-articles` (
  ...
  `article_status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '文章状态：0 草稿箱 1 已发布',
  ...
  `is_essence` tinyint(4) NOT NULL DEFAULT '0' COMMENT '阅读加精',
  `comment_status` tinyint(4) NOT NULL DEFAULT '1' COMMENT '评论状态：0 关闭 1 开放',
  `comment_count` int(11) NOT NULL DEFAULT '0' COMMENT '评论数量',
  `last_comment_user_id` int(11) DEFAULT NULL COMMENT '最后回复用户 id',
  PRIMARY KEY (`id`),
...
CREATE TABLE `news-categories` (
  ...
  `sort` int(11) DEFAULT NULL COMMENT '类别显示顺序',
  `article_count` int(11) DEFAULT NULL COMMENT '该类别下文章数量',
  PRIMARY KEY (`id`),
...
CREATE TABLE `t_company` (
  ...
  `industryClassify` tinyint(4) DEFAULT NULL COMMENT '行业 0-互联网 1-金融 2-制造 3-医疗 4-地产 5-其他',
  `employeesClassify` tinyint(4) DEFAULT NULL COMMENT '员工数目 0-1~50 1-50~200 2-200~1000 3-1000~10000 4-10000+',
  `logoIcon` varchar(255) DEFAULT NULL COMMENT 'Logo',
  `visionRemark` varchar(255) DEFAULT NULL COMMENT '愿景',
  `followCount` int(11) DEFAULT NULL COMMENT '关注数目',
  PRIMARY KEY (`id`),
...
-- ----------------------------
BEGIN;
INSERT INTO `t_company` VALUES (3, '2021-12-17 10:08:26.496590', '2022-01-30 14:17:57.975769', '郑州画作科技有限公司', '<p>郑州画作科技有限公司1</p>', 'http://www.baidu.com', '河南省郑州市', '2021-12-01 00:00:00', 2, 2, 'http://127.0.0.1:8001/uploads/20211217/5595c780-5edf-11ec-b7ca-818009c310ce.png', '全球创作与交流平台', 10);
INSERT INTO `t_company` VALUES (4, '2021-12-17 18:55:29.139682', '2022-01-30 14:18:00.881912', '牧原', '<p>牧原</p>', 'www.zh.com', '郑州市', '2021-12-03 00:00:00', 2, 3, 'http://127.0.0.1:8001/uploads/20211217/c9533700-5f27-11ec-81ed-55fd36f660dd.png', '全球创作与交流平台', 10);
INSERT INTO `t_company` VALUES (5, '2021-12-23 10:39:13.177859', '2022-01-30 14:18:03.526284', '字节跳动科技', '<p>字节跳动科技</p>', 'www.', '郑州', '2021-12-16 00:00:00', 0, 2, 'http://127.0.0.1:8001/uploads/20211223/7a9ba6d0-6399-11ec-b451-9fa1a67376b1.png', '全球创作与交流平台', 30);
INSERT INTO `t_company` VALUES (6, '2021-12-23 14:50:13.972929', '2022-01-30 14:18:06.412916', '郑州画作科技有限公司', '<p>宇通客车以美好人们的出行为愿景，客车行业龙头</p>', 'www.', '郑州市', '2021-12-24 00:00:00', 0, 2, 'http://127.0.0.1:8001/uploads/20220117/951e21c0-777d-11ec-b347-215dadacce47.jpeg', '宇通客车以美好人们的出行为愿景，客车行业龙头', 60);
COMMIT;
...
CREATE TABLE `t_org` (
  ...
  `createTime` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '创建时间',
  `updateTime` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6) COMMENT '更新时间',
  `parentId` bigint(20) DEFAULT NULL COMMENT '父组织ID',
...
-- ----------------------------
BEGIN;
INSERT INTO `t_org` VALUES (2, '2022-02-11 20:08:46.979314', '2022-02-13 22:54:43.544087', NULL, 'devling', 'http://127.0.0.1:8001/uploads/20220212/96b37340-8bbf-11ec-a99b-01f64c1038bc.png', 'ceo,tag1,tag12', 'CEO', 'CEO OFFICE', 'http://127.0.0.1:8001/uploads/20220211/63c74740-8b33-11ec-a69b-db30c0e7a0be.png', '郑州', 6, '画作科技');
INSERT INTO `t_org` VALUES (3, '2022-02-11 20:29:51.156099', '2022-02-13 10:34:42.455000', 2, 'xiaoming1', 'http://127.0.0.1:8001/uploads/20220212/9ba3a410-8bbf-11ec-a99b-01f64c1038bc.png', 'cto,uuu,lll', 'cto', 'cto office', NULL, '杭州', 40, '画作');
INSERT INTO `t_org` VALUES (4, '2022-02-12 15:29:25.419947', '2022-02-13 18:33:52.983149', 3, 'hanmeimei', 'http://127.0.0.1:8001/uploads/20220212/742c54c0-8bd5-11ec-a99b-01f64c1038bc.png', 'cfo,tag3,rrrr', 'cfo ', 'cfo office', NULL, '杭州', 40, '画作');
INSERT INTO `t_org` VALUES (5, '2022-02-13 18:35:29.721785', '2022-02-13 10:36:37.611000', 2, 'lilei', 'http://127.0.0.1:8001/uploads/20220213/9bfea230-8cb8-11ec-a99b-01f64c1038bc.png', 'cmo', 'cmo', 'cmo office', NULL, '郑州', 6, '郑州画作科技公司');
INSERT INTO `t_org` VALUES (8, '2022-02-13 20:48:04.966611', '2022-02-13 20:48:04.966611', NULL, 'lllei', 'http://127.0.0.1:8001/uploads/20220213/2a4caac0-8ccb-11ec-8cb6-49924353b815.png', 'ceo', 'ceo', 'ceo', NULL, '郑州', 4, '牧原');
INSERT INTO `t_org` VALUES (9, '2022-02-14 09:05:27.748003', '2022-02-14 09:05:27.748003', NULL, '韩明明', 'http://127.0.0.1:8001/uploads/20220214/2b6e1a80-8d32-11ec-ac6e-f55d26fa88d0.png', 'CEO', 'CEO', 'CEO', NULL, '杭州', 5, '字节跳动科技');
COMMIT;
