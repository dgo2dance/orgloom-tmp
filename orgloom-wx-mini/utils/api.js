...
// ALL server-side API
const Host = "http://localhost:29090/xinchacha/api"
// const Host = "https://wsq.kawaapp.com"
// const Host = "https://www.bestplanning.art/xinchacha/api"

//        var api = 'http://localhost:29090/xinchacha/api';
// var api = 'https://www.bestplanning.art/xinchacha/api';
...
function getPostList(params) {
  ...
  return req({
    url: `${Host}/t/salary/discuss/post/list?q`,
    method: 'GET',
  })
}
