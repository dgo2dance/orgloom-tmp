...
Page({
  ...
  async getPerson(id) {
      const json = await api.getPersonId({
        query: {
          id:id
      }
      });
      ...
      if (json.code == 200) {
            ...
            console.log("----fri"+json.data.friendshow.split(",").length);
            console.log("----you"+json.data.you.split(",").length);
            console.log("this.data.itemYou.length"+this.data.itemYou.length);
            console.log("this.data.itemYou.length"+this.data.itemYou.length);
