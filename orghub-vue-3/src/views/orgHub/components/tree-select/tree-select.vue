<template>
    <el-select  :disabled="disabled" :clearable="clearable" @clear="clearHandler" :size="size" filterable :filter-method="treeSelectFilter" v-model="selectedText" :placeholder="placeholder" style="width: 100%;" ref="selectReport">
        <el-option disabled style="height:100%;max-height: 245px;overflow: auto;background-color:#fff" :value="selectedText">
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            console.log("---this.selectText",this.selectedText);
        ...
        methods: {
            ...
            handleNodeClick(node) {
                ...
                console.log("---this.node click",this.selectedText);
