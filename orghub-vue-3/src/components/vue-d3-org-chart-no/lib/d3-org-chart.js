...
export class OrgChart {
  ...
  constructor () {
    ...
    const attrs = {
      ...
      buttonContent: ({ node, state }) => {
        ...
        return `<div style="border-radius:3px;padding:3px;font-size:10px;margin:auto auto;background-color:#eee"> ${icons[
          state.layout
        ](node.children)}  </div>`
      },
      layoutBindings: {
  ...
  render () {
    ...
    // const container =d3.select(document.querySelector('#orgChart'));
    ...
    attrs.svg
      ...
      .each(function (d, i, arr) {
        if (!d._mounted) {
          ...
          // console.log("----attrs.nodeContent----",attrs.nodeContent);
          const app =  createApp({
            render () {
              //   return this.$createElement(attrs.nodeContent.bind(this)(d, i, arr, attrs), {
              //   // return h(attrs.nodeContent, {
              //   // 'class': { card: true },
              ...
              //             },
              //             [
              //               h('div',{ style: { minWidth:'80px' } },[h('div','',h('img',{
              //                 'class': { cardImage: true },
              //                 'src':d.data.imageUrl,
              //               },))]),

              //               h('div',{},[
              //                 h('div',{style:{marginLeft:'20px',marginTop:'5px',fontSize:'16px',fontWeight:'bold'}},d.data.name),
              //                 h('div',{style:{marginLeft:'20px',marginTop:'3px',fontSize:'12px',}},d.data.positionName+' '+d.data.tags)
