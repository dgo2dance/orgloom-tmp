...
export class BaseSysUserService extends BaseService {
   ...
   */
         async updateUserName(param) {
          ...
          const id = this.ctx.admin.userId;
          console.log("----update user  name---id------",id);


          await this.baseSysUserEntity.update({id:id},{username:param.username});
        //  await this.updateUserRole(param);
          return 'ok';
        }
